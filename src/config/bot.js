...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "Create a ticket for support!", // required by Discord API, not shown in the client
        state: "Washington State Roleplay",     // this is what people actually see
        type: 3,               // Custom
      },
    ],
  },
  ...
  applications: {
    ...
    defaultQuestions: [
      ...
      { question: "Why do you want to become apart of our moderation team?", required: true },
      { question: "What makes you different from other applicants?", required: true },
      { question: "What days can you get on?", required: true },
      { question: "What does RDM stand for, describe it, and what would you do if you witnessed RDM?", required: true },
      { question: "What does VDM stand for, describe it, and what would you do if you witnessed VDM?", required: true },
      { question: "What does FRP stand for, describe it, and what would you do if you witnessed FRP?", required: true },
      { question: "What does NITRP stand for, describe it, and what would you do if you witnessed NITRP?", required: true },
      { question: "What does FearRP stand for, describe it, and what would you do if you witnessed FearRP?", required: true },
      { question: "How would you define power gaming?", required: true },
      { question: "How would you define metagaming?", required: true },
      { question: "How would you react if while responding to a mod call, a player begins shooting?", required: true },
      { question: "How would you respond when handling a mod scene involving an angry/screaming player?", required: true },
      { question: "What steps would you take when identifying someone underage?", required: true },
      { question: "If you witnessed another staff member abusing their abilities, what would you do?", required: true },
      { question: "Do you understand that if you ask for your application to be reviewed, it may be denied?", required: true },
      { question: "Do you understand that if this application gets accepted you must go through the necessary training?", required: true },
      { question: "Do you have any questions for us or anything you want us to know?", required: true },
    ],
